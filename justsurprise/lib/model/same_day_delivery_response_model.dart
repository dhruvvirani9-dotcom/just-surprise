...
class SameDayDeliveryResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<SameDayDeliveryProductData>? productData;
  List<FilterDetail>? filterDetail;

  SameDayDeliveryResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  SameDayDeliveryResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <SameDayDeliveryProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new SameDayDeliveryProductData.fromJson(v));
      });
    }
...
class SameDayDeliveryProductData {
  int? id;
  String? productName;
  String? slug;
  String? image;
  ...
  SameDayDeliveryProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
