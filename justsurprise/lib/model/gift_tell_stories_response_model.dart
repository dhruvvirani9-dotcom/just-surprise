...
class GiftTellStoriesViewAllResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<GiftTellStoriesProductData>? productData;
  List<FilterDetail>? filterDetail;

  GiftTellStoriesViewAllResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  GiftTellStoriesViewAllResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <GiftTellStoriesProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new GiftTellStoriesProductData.fromJson(v));
      });
    }
...
class GiftTellStoriesProductData {
  int? id;
  String? productName;
  String? slug;
  String? image;
  ...
  GiftTellStoriesProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
