...
class GiftTrendsViewAllResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<GiftTrendsProductData>? productData;
  List<FilterDetail>? filterDetail;

  GiftTrendsViewAllResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  GiftTrendsViewAllResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <GiftTrendsProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new GiftTrendsProductData.fromJson(v));
      });
    }
...
class GiftTrendsProductData {
  ...
  GiftTrendsProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
