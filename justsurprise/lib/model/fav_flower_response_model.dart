...
class FavFlowerViewAllResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<FavFlowerProductData>? productData;
  List<FilterDetail>? filterDetail;

  FavFlowerViewAllResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  FavFlowerViewAllResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <FavFlowerProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new FavFlowerProductData.fromJson(v));
      });
    }
...
class FavFlowerProductData {
  ...
  FavFlowerProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
