class CategoryClickResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<CategoryProductData>? productData;
  List<FilterDetail>? filterDetail;

  CategoryClickResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  CategoryClickResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <CategoryProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new CategoryProductData.fromJson(v));
      });
    }
