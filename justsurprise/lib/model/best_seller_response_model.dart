...
class BestSellerResponseModel {
  ...
  int? totalPage;
  String? message;
  List<BestSellerProductData>? productData;
  ...
  BestSellerResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product_data'] != null) {
      productData = <BestSellerProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new BestSellerProductData.fromJson(v));
      });
    }
...
class BestSellerProductData {
  ...
  BestSellerProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
