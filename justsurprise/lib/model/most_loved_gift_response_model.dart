import 'find_gift_response_model.dart';
import 'just_surprise_response_model.dart';

class MostLoveGiftViewAllResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<MostLovedGiftProductData>? productData;
  List<FilterDetail>? filterDetail;

  MostLoveGiftViewAllResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  MostLoveGiftViewAllResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <MostLovedGiftProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new MostLovedGiftProductData.fromJson(v));
      });
    }
...
class MostLovedGiftProductData {
  int? id;
  String? productName;
  String? slug;
  String? image;
  ...
  MostLovedGiftProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
