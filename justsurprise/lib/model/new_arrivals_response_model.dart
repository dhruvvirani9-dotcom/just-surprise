...
class NewArrivalsResponseModel {
  ...
  int? totalPage;
  String? message;
  List<NewArrivalsProductData>? productData;
  List<FilterDetail>? filterDetail;

  NewArrivalsResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  NewArrivalsResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product_data'] != null) {
      productData = <NewArrivalsProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new NewArrivalsProductData.fromJson(v));
      });
    }
...
class NewArrivalsProductData {
  ...
  NewArrivalsProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
