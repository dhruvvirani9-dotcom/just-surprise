class ProductDetailResponseModel {
  ...
  ProductDetailResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    productData = json['product_data'] != null
        ...
        : null;
    offerHeading = json['offer_heading'] != null
        ? new OfferHeading.fromJson(json['offer_heading'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.offerHeading != null) {
      data['offer_heading'] = this.offerHeading!.toJson();
    }
...
class OfferHeading {
  ...
  OfferHeading({this.offetTitle, this.offerDescription});

  OfferHeading.fromJson(Map<String, dynamic> json) {
    offetTitle = json['offet_title'];
    offerDescription = json['offer_description'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['offet_title'] = this.offetTitle;
