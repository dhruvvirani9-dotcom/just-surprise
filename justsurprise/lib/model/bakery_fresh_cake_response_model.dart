...
class BakeryFreshCakeViewAllResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<BakeryProductData>? productData;
  List<FilterDetail>? filterDetail;

  BakeryFreshCakeViewAllResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  BakeryFreshCakeViewAllResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <BakeryProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new BakeryProductData.fromJson(v));
      });
    }
...
class BakeryProductData {
  ...
  BakeryProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
