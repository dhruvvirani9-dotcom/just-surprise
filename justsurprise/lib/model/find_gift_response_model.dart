...
class FindGiftResponseModel {
  int? status;
  String? currentPage;
  int? totalPage;
  String? message;
  List<FindGiftProductData>? productData;
  List<FilterDetail>? filterDetail;

  FindGiftResponseModel(
      {this.status,
        this.currentPage,
        this.totalPage,
        this.message,
  ...
  FindGiftResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    currentPage = json['current_page'];
    totalPage = json['total_page'];
    message = json['message'];
    if (json['product_data'] != null) {
      productData = <FindGiftProductData>[];
      json['product_data'].forEach((v) {
        productData!.add(new FindGiftProductData.fromJson(v));
      });
    }
...
class FindGiftProductData {
  ...
  FindGiftProductData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
