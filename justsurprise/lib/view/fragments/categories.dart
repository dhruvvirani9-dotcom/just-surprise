...
import 'package:justsurprise/view_models/controller/categories_fragment_view_model.dart';
...
class _CategoriesFragmentState extends State<CategoriesFragment> {
  final categoriesVM = Get.put(CategoriesFragmentViewModel());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Obx(() => categoriesVM.isConnected.value ? getIsLoading() ? categoriesVM.categoryResponseData.value.categoryViewAllData != null ?
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: InkWell(
                  onTap: () {
                    categoriesVM.CategorieIndex.value = index;
